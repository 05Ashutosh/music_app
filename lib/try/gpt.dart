    ...
    SystemChrome.setSystemUIOverlayStyle(
      const SystemUiOverlayStyle(
        ...
        statusBarIconBrightness: Brightness
            .dark, // Replace with your desired status bar icon color
      ),
    );
  }
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: const Center(child: Icon(CupertinoIcons.search, size: 18)),
                  ),
                ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: const Center(child: Icon(CupertinoIcons.heart, size: 18)),
                  ),
                ),
              ],
            ),
